      ...
      <div className="max-w-[1200px] mx-auto px-6 flex flex-col gap-24">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-14">
          ...
          <div className="w-full lg:w-[45%]">
            <div className="relative w-full aspect-square md:aspect-[4/3] rounded-xl overflow-hidden shadow-xl border-8 border-primary/10">
              <Image
          ...
          <div className="w-full lg:w-[55%] flex flex-col text-left">
            <h2 className="text-[32px] md:text-[40px] font-bold text-[#111827] mb-6 leading-[1.2]">
              Solve Customer <span className="text-primary">Support<br /> Challenges with AI</span>
            </h2>
            ...
            <p className="text-[15px] md:text-[16px] text-[#4b5563] leading-[1.8] font-medium border-l-4 border-primary pl-4">
              As an AI-first company, Netwit doesn't just use AI for customer support solutions — we embed it into the DNA of our customer support solutions, helping you do the same.
            </p>
          </div>
        </div>

        {/* Bottom Banner Layout */}
        <div className="relative mt-12 bg-gradient-to-r from-primary-600 to-primary-800 rounded-2xl md:rounded-3xl shadow-[0_10px_30px_rgba(11,61,145,0.2)]">
