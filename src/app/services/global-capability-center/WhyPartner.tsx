...
const buildingCards = [
  {
    ...
    title: "Netsmartz Towers",
    description: "Netsmartz Towers redefines modern workspaces with a perfect blend of thoughtful amenities and cutting-edge infrastructure."
  },
  {
    image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800",
    title: "Netsmartz House",
  ...
  },
  {
    ...
    title: "Netsmartz Center",
    description: "Netsmartz Center, located in Mohali's IT hub, offers premium workspaces that combine comfort, productivity, and convenience."
  },
  {
    image: "https://images.unsplash.com/photo-1481026469463-66327c86e544?auto=format&fit=crop&q=80&w=800",
    title: "Netsmartz Square",
    description: "Netsmartz Square, our very campus in Mohali IT Park, offers premium facilities on one acre, redefining the corporate workspace experience."
  },
  {
    image: "https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&q=80&w=800",
    title: "AppWorx",
    description: "Netsmartz AppWorx, located in Panchkula, is a platform for innovation, collaboration, and business growth."
  }
];
      ...
      <div className="max-w-[1240px] mx-auto px-6">
        ...
        <div className="text-center max-w-[1000px] mx-auto mb-16">
          <h2 className="text-[28px] md:text-[34px] font-bold text-[#111827] mb-6 leading-snug">
            Why Netsmartz is the Ideal Partner for Your GCC
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-[1050px] mx-auto mb-16">
          {stats.map((stat, idx) => (
            <div key={idx} className="border border-gray-200 rounded-sm p-6 flex flex-col justify-center shadow-sm hover:shadow-md transition-shadow bg-white">
              <span className="text-[26px] md:text-[32px] font-bold text-[#ea580c] mb-1">
                {stat.value}
              </span>
          ...
          {buildingCards.map((card, idx) => (
            <div key={idx} className="relative h-[250px] md:h-[280px] w-full overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 md:p-6 text-left">
                <h3 className="text-[#ea580c] font-bold text-[16px] md:text-[18px] mb-2">
                  {card.title}
                </h3>
