...
export function MdrIndustries() {
  return (
    <section className="bg-[#FFF4EB] py-24 px-6 w-full flex flex-col items-center">
      ...
      <div className="text-center mb-24 max-w-[800px] w-full">
        ...
        <button className="bg-[#F06F12] hover:bg-[#d5610e] text-white font-medium py-3 px-8 rounded-[4px] text-[15px] transition-colors shadow-sm tracking-wide">
      ...
      <div className="max-w-[1100px] w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          ...
          {/* SaaS Card */}
          <div className="bg-white rounded-[10px] p-8 md:p-10 shadow-sm border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-md h-full">
            <div className="w-[46px] h-[46px] bg-[#FFF4EB] rounded-[8px] flex items-center justify-center text-accent-gold mb-6 border border-[#f06f12]/20">
              <Cloud className="w-[20px] h-[20px] text-[#f06f12]" strokeWidth={1.5} />
            </div>
            ...
            <Link href="#" className="mt-auto text-[#f06f12] font-semibold text-[13.5px] hover:underline flex items-center gap-1.5 transition-colors">
          ...
          <div className="bg-white rounded-[10px] p-8 md:p-10 shadow-sm border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-md h-full">
            <div className="w-[46px] h-[46px] bg-[#FFF4EB] rounded-[8px] flex items-center justify-center text-accent-gold mb-6 border border-[#f06f12]/20">
              <Factory className="w-[20px] h-[20px] text-[#f06f12]" strokeWidth={1.5} />
            </div>
            <h4 className="text-[17.5px] font-bold text-[#222] mb-4 leading-snug tracking-tight">
          ...
          <div className="bg-white rounded-[10px] p-8 md:p-10 shadow-sm border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-md h-full">
            <div className="w-[46px] h-[46px] bg-[#FFF4EB] rounded-[8px] flex items-center justify-center text-accent-gold mb-6 border border-[#f06f12]/20">
              <HeartPulse className="w-[20px] h-[20px] text-[#f06f12]" strokeWidth={1.5} />
            </div>
            <h4 className="text-[17.5px] font-bold text-[#222] mb-4 leading-snug tracking-tight">
