...
export function AzureMigrationIndustries() {
  return (
    <section className="bg-[#FFF4EB] py-24 px-6 w-full">
      <div className="max-w-[1240px] mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1000px] mx-auto text-left">
          {/* Healthcare Card */}
          <div className="bg-white rounded-[12px] p-8 md:p-10 shadow-sm border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-lg h-full">
            <div className="w-[50px] h-[50px] bg-[#FFF4EB] rounded-lg shadow-sm flex items-center justify-center text-accent-gold mb-6 relative">
              <Database className="w-[20px] h-[20px] absolute text-accent-gold" strokeWidth={1.5} />
              <div className="absolute top-[28px] left-[26px] bg-[#FFF4EB] border border-[#f06f12]/10 rounded-full w-[20px] h-[20px] flex items-center justify-center shadow-sm">
                <HeartPulse className="w-[12px] h-[12px] text-accent-gold" strokeWidth={2.5} />
              </div>
            </div>
            ...
            <Link href="#" className="text-accent-gold font-bold text-[13.5px] hover:underline mt-auto flex items-center gap-1.5 transition-colors group">
          ...
          <div className="bg-white rounded-[12px] p-8 md:p-10 shadow-sm border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-lg h-full">
            <div className="w-[50px] h-[50px] bg-[#FFF4EB] rounded-lg shadow-sm flex items-center justify-center text-accent-gold mb-6 relative">
              <Cloud className="w-[22px] h-[22px] absolute text-accent-gold" strokeWidth={1.5} />
              <div className="absolute top-[28px] left-[26px] bg-[#FFF4EB] border border-[#f06f12]/10 rounded-full w-[20px] h-[20px] flex items-center justify-center shadow-sm">
                <BarChart2 className="w-[12px] h-[12px] text-accent-gold" strokeWidth={2.5} />
              </div>
            </div>
