    ...
    <section className="bg-surface-2 py-24 px-6 w-full">
      <div className="max-w-[1240px] mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[1000px] mx-auto text-left">
          {/* Healthcare Card */}
          <div className="bg-white rounded-xl p-8 md:p-10 shadow-[0_4px_25px_rgba(0,0,0,0.02)] border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-lg h-full">
            <div className="w-12 h-12 bg-[#FFF4EB] rounded-lg border border-[#f06f12]/20 shadow-sm flex items-center justify-center text-accent-gold mb-6 relative">
              <Database className="w-[22px] h-[22px] absolute text-accent-gold" strokeWidth={1.5} />
              <div className="absolute bottom-[-3px] right-[-3px] bg-[#FFF4EB] border border-[#f06f12]/20 rounded-full w-[22px] h-[22px] flex items-center justify-center shadow-sm">
                <HeartPulse className="w-3.5 h-3.5 text-accent-gold" strokeWidth={2.5} />
              </div>
            </div>
            ...
            <Link href="#" className="text-accent-gold font-bold text-[14px] hover:underline mt-auto flex items-center gap-1.5 transition-colors group">
          ...
          <div className="bg-white rounded-xl p-8 md:p-10 shadow-[0_4px_25px_rgba(0,0,0,0.02)] border border-[#f06f12]/10 flex flex-col items-start transition-transform hover:-translate-y-1 hover:shadow-lg h-full">
            <div className="w-12 h-12 bg-[#FFF4EB] rounded-lg border border-[#f06f12]/20 shadow-sm flex items-center justify-center text-accent-gold mb-6 relative">
              <Cloud className="w-[24px] h-[24px] absolute text-accent-gold" strokeWidth={1.5} />
              <div className="absolute bottom-[-3px] right-[-3px] bg-[#FFF4EB] border border-[#f06f12]/20 rounded-full w-[22px] h-[22px] flex items-center justify-center shadow-sm">
                <BarChart2 className="w-3 h-3 text-accent-gold" strokeWidth={2.5} />
              </div>
            </div>
