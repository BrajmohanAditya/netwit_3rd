        ...
        <div className="max-w-[850px] w-full grid grid-cols-1 md:grid-cols-[1.3fr,1fr] gap-16 items-center mx-auto">
          ...
          <div className="flex flex-col relative w-full pr-4">
             ...
             <div className="flex items-center gap-4 z-10">
               ...
               <div className="flex flex-col">
                 <span className="text-[14px] font-bold text-[#222]">George Kounis</span>
                 <span className="text-[10px] text-[#777] font-bold mt-0.5 tracking-wide uppercase">Managing Director, Single Click Solutions</span>
               </div>
             </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start w-full gap-4 relative pl-4 md:pl-0 border-l border-gray-100/50 md:border-none">
             ...
             <div className="bg-[#f06f12] p-5 text-white font-bold h-[160px] w-full max-w-[320px] relative flex flex-col justify-end shadow-md overflow-hidden rounded-[2px] cursor-pointer group hover:shadow-lg transition-transform hover:-translate-y-1">
                ...
                <div className="absolute right-[-20px] bottom-0 w-[60%] h-[95%] opacity-95 mix-blend-luminosity z-0 flex items-end justify-center">
                   <div className="w-full h-full bg-white/20 rounded-tl-full flex items-end justify-center px-4 overflow-hidden pt-6 pb-[-5px]">
                       <div className="w-[85px] h-full bg-[#111] rounded-t-full flex flex-col items-center justify-end pb-0 overflow-hidden">
                          <div className="w-[45px] h-[50px] bg-orange-100 rounded-t-[20px] rounded-b-[40px] mb-[2px]"></div>
                          <div className="w-[85px] h-[45px] bg-black rounded-t-[30px] mb-[-10px]"></div>
                       </div>
                   </div>
                </div>
