      ...
      <div className="max-w-[1250px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-12">
           <div className="space-y-6 max-w-2xl">
              <span className="text-[10px] text-amber-500 font-black uppercase tracking-[0.5em] mb-4 block italic">The Netwit Fiscal Protocol</span>
              <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter italic shadow-sm">Capital Stewardship <span className="text-amber-500 underline decoration-amber-500/30 font-black">Architecture.</span></h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((item, index) => (
            <div 
              key={index} 
              className="group bg-[#0f172a]/40 backdrop-blur-3xl border border-amber-500/10 rounded-[3.5rem] p-10 flex flex-col h-full hover:border-amber-500/30 transition-all duration-500 hover:-translate-y-2 shadow-2xl relative overflow-hidden"
            >
              ...
              <div className="flex justify-between items-start mb-10">
                 <div className="w-16 h-16 rounded-2xl bg-amber-600/5 border border-amber-600/10 flex items-center justify-center group-hover:bg-amber-600 group-hover:text-white transition-all shadow-lg">
              ...
              <h3 className="text-2xl font-black text-white mb-5 group-hover:text-glow_amber transition-all italic underline decoration-amber-600/20">{item.title}</h3>
              <p className="text-sm text-slate-400 font-light leading-relaxed flex-1 border-l-2 border-white/5 pl-8 group-hover:border-amber-500 transition-colors">
                 {item.description}
              </p>
              
              <div className="mt-10 flex items-center justify-between pt-8 border-t border-white/5 text-[10px] font-black uppercase tracking-widest text-slate-600 group-hover:text-amber-400 transition-colors italic">
        ...
        <div className="mt-24 p-12 bg-gradient-to-br from-amber-900/10 via-[#0f172a] to-blue-900/10 border border-amber-500/10 rounded-[4rem] text-center relative overflow-hidden backdrop-blur-3xl group px-16">
           <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_0%,rgba(251,191,36,0.1),transparent)] pointer-events-none opacity-40"></div>
           
           <div className="relative z-10 max-w-2xl mx-auto space-y-8">
              <span className="inline-block text-[10px] text-amber-400 font-black uppercase tracking-[0.5em] mb-4 italic">The Global Capital Desk</span>
              <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-none italic uppercase underline decoration-amber-600/30">Fiscal <span className="text-amber-500">Stewardship.</span></h2>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                 <button className="px-14 py-6 bg-amber-600 text-white font-black rounded-full hover:scale-105 transition-transform flex items-center justify-center gap-3 shadow-[0_20px_60px_rgba(251,191,36,0.3)] italic">
