...
export function DataPodsWhyNetsmartz() {
  const reasons = [
      ...
      <div className="max-w-[1100px] w-full text-center mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          {reasons.map((reason, idx) => (
            <div 
              key={idx} 
              className="bg-[#FFF4EB] border border-[#f06f12]/20 rounded-[4px] p-5 flex items-center justify-center text-center shadow-sm min-h-[120px] transition-shadow hover:shadow-md"
            >
